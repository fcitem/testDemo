...
<head>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/newCar.js"></script>
<script type="text/javascript"
...
<div >
	...
	<div class=newcarhead>
		<span style="color: #22ac38;height: 100px;margin-left: 940px;line-height: 130px;"><b>完善车辆信息你就可以发布新车了!</b></span>
	</div>
	<div style="background-color: #f1f1f1">
	<div style="margin-left: 350px;" >
		<form id="newCar" enctype="multipart/form-data" action="/jspbotstrap/carInfo/createCar" method="post">
			...
			<div style="margin-bottom: 10px">
				...
				<!-- <input type="" id="Cartype" name="Cartype"
					style="width: 400px; height: 52px; font-size: 30px" /> -->
			...
			<div style="margin-bottom: 10px">
				...
				<textarea id="Cardescribe" name="Cardescribe"
					style="width: 400px; height: 80px; font-size: 30px"></textarea>
			</div>
			<div class="newCar">
				<ul>
					<li id="save">点击发布</li>
